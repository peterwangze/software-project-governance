 ...
 * open-folder available, and `dsh plugin remove` stays symmetric.
 *
...
export function ensurePreset(ctx) {
  ...
  const userDir = join(resolveDshHome(), '.agent-presets', PRESET_ID)
  const outcome = { synced: false, dir: userDir, version }
  try {
