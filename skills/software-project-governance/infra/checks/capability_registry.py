...
See docs/requirements/verify-workflow-split-phase2-capability-registry-0.60.0.md
...
# import was rejected during 0.60.0 because it triggered a circular import
