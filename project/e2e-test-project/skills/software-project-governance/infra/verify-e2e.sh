...
E2E_DIR="$SCRIPT_DIR/../../../project/e2e-test-project"
PASS=0
FAIL=0
...
if [ -d "$E2E_DIR/.git" ]; then
    ...
    [ -f "$E2E_DIR/.git/hooks/commit-msg" ] && green "commit-msg hook installed" || red "commit-msg hook missing"
    ...
    [ -x "$E2E_DIR/.git/hooks/commit-msg" ] && green "commit-msg hook executable" || red "commit-msg hook not executable"
