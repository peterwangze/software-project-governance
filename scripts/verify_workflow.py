...
REQUIRED_FILES = {
    ...
    "Main Workflow Entry": ROOT / "workflows/software-project-governance/main-workflow.md",
    "Tools Index": ROOT / "workflows/software-project-governance/TOOLS.md",
...
WORKFLOW_SNIPPETS = {
    ...
    ROOT / "workflows/software-project-governance/main-workflow.md": [
        "## 两个基础目的",
        "## 三层内容架构",
        "## 场景 → 子工作流匹配规则",
        "## 跨层调用协议",
    ...
    ROOT / "workflows/software-project-governance/TOOLS.md": [
        "## 工具总览",
        "## 工具详情",
        "## 工具与子工作流的关系矩阵",
        "## 添加新工具的约定",
