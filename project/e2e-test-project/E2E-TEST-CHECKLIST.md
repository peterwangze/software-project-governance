...
| `project/e2e-test-project/.governance/plan-tracker.md` | `工作流版本` / `0.37.0` / `操作权限模式` / `default-confirm` | target_fixture |
| `project/e2e-test-project/skills/software-project-governance/SKILL.md` | `version: 0.37.0` / `Coordinator` / `Agent Team` | target_fixture |
