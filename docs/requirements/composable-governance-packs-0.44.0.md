...
- Manifest checks fail if the pack registry is not declared as a canonical product artifact, is not an explicit product file, is missing, or is not git-tracked.
