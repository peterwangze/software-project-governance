...
| SKILL | 覆盖阶段 | 审查对象 |
|-------|---------|---------|
| requirement-review | 1-2 (立项·调研) | PR/FAQ、OKR、需求澄清报告、竞品分析 |
| design-review | 3-5 (选型·基础设施·架构) | 技术选型报告、ADR、系统设计文档 |
| code-review | 6 (开发) | 代码 diff、实现质量 |
| tech-review | 5 (架构设计) | 技术方案、架构决策 |
| test-review | 7 (测试) | 测试策略、测试计划、关键用例 |
| release-review | 8-9 (CI/CD·发布) | CI 配置、发布检查清单、回滚方案 |
| retro-review | 10-11 (运营·维护) | 运营数据、复盘报告、改进计划 |
