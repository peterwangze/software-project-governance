...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 项目管理工作流插件 | 维护（并行活跃：规划） | 119 | 103 | 0 | 2 | G11 通过 | 2026-04-29 |
...
| **0.7.0** | **规划中** | **2026-05-04** | **外部验证 + 企业实践 + 交互覆盖闭环（12 个任务，6 完成 + 6 未开始）** | **AUDIT-003(P0)✅, FIX-014(P0)✅, FIX-013(P1)✅, AUDIT-034(P2)✅, AUDIT-036(P2)✅, AUDIT-038(P2)✅ + AUDIT-004(P1), AUDIT-006(P1), AUDIT-023(P1), MAINT-013(P1), MAINT-014(P1), MAINT-023(P1)** | **外部项目验证报告, governance-init/命令端到端验证, 蓝军单agent适配, 现代发布实践, 用户数据边界/agent入口差异文档, Gemini最小验证, 目标锚定强制机制** |
